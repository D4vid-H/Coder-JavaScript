import { changoNav, crearTarjetaProducto, PRODUCTOS, arrayCarrito } from '../main.js';
...
export class Compra {
    ...
    cargarCompra(compraNueva) {
      debugger
      arrayCarrito.some((element) => element.id === compraNueva.id) ? sumarcompra(compraNueva): (arrayCarrito.push(compraNueva),
